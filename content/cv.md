...
- LinkedIn: [tachadol-suthisomboon-213182140](https://www.linkedin.com/in/tachadol-suthisomboon-213182140/)
- Google Scholar: [Profile](https://scholar.google.com/citations?user=tk3A2FUAAAAJ&hl=en)

## Professional Summary

Robotics and Mechatronics Engineer with 5+ years of combined experience in academic research and industry R&D. Experienced in designing grippers, tactile sensing systems, robotic tools, robotic arms, mobile robots, and adaptive robotic mechanisms. Proficient in CAD/CAE, machine design, compliant mechanisms, and robotics electrical integration, with a strong record of cross-disciplinary execution.
...
### Brain Lab, VISTEC, Rayong, Thailand
Research Engineer (Part-/Full-time) | Aug 2020 - May 2023

- Led mechanical and electronic integration of [adaptive pipeline inspection gauges (MC-PIG)](../projects/pipeline-inspection-gauge-morphological-speed-control/).
- Optimized mechanical design using CFD to improve controllable speed range.
- Received SICE International Young Authors Award (2025) through resulting publication output.
...
### Japan-Europe Master on Advanced Robotics (JEMARO), Erasmus Mundus
Keio University (Japan) and University of Genoa (Italy) | 2021 - 2023

- Double Master's in Robotics Engineering and Science Engineering
- Erasmus Mundus Full Scholarship Recipient
- GPA: 3.75 / 4.00
- Thesis: [Design and Development of Jamming-Based Stiffness-Adjustable Wheel on Soft Terrain](../projects/jamming-based-stiffness-adjustable-wheel-on-soft-terrain/)
...
- Borijindakul P., Suthisomboon T. et al., [Synergy Between Soft Feet and an Active Tail to Enhance the Climbing Ability of a Bio-inspired Climbing Robot](https://link.springer.com/article/10.1007/s42235-023-00459-2), Journal of Bionic Engineering, 2024
- Rothomphiwat K. et al., [Advanced Collaborative Robots for the Factory of the Future](https://ieeexplore.ieee.org/abstract/document/9382664), IEEE/SICE SII, 2021
- Suthisomboon T., Bargiel S., Rabenorosoa K., Pengwang E., [Design and Simulation of XZ MEMS Micropositioning with 3D-Complex Structure](https://ieeexplore.ieee.org/abstract/document/9139150), DTIP Symposium, 2020
- Patent: Pipeline Locomotion Device, Thailand Patent No. 2103002124, 2021 (Co-inventor)

## Skills

- Mechanical Design: SolidWorks, Fusion 360, Inventor, Inventor Nastran, Autodesk CFD
- Prototyping: 3D printing (FDM/SLA), CNC, silicone molding and casting, laser cutter, workshop tools
- Electronics: Circuit and PCB design
- Programming: Python, C#, MATLAB, ROS 1 and ROS 2
...
- SICE International Young Authors Award, SII 2025
- Erasmus Mundus Full Scholarship (JEMARO)
- PTTEP Innovation Awards (Gold and Silver)
- FIBO Top Graduate, 2019 Academic Excellence Awards
